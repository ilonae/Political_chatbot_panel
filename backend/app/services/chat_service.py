...
class ChatService:
    ...
    async def _get_recommended_answers(cls, user_input: str, session_id: str, language: str, 
        ...
        try:
            ...
            templates = {
                'de': {
                    'opening': f"""Erstellen Sie {num_recommendations} prägnante, provokative Fragen für eine politische Debatte.
                ...
                'en': {
                    'opening': f"""Generate {num_recommendations} concise, provocative questions for a political debate with the debate partner.
